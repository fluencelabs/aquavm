...
fn stream_merging_v0() {
    ...
    let expected_trace_1 = vec![
        ...
        executed_state::fold(vec![
            executed_state::subtrace_lore(7, subtrace_desc(15 as PosType, 2), subtrace_desc(21 as PosType, 0)),
            executed_state::subtrace_lore(9, subtrace_desc(17 as PosType, 2), subtrace_desc(21 as PosType, 0)),
            executed_state::subtrace_lore(12, subtrace_desc(19 as PosType, 2), subtrace_desc(21 as PosType, 0)),
        ]),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
    ...
    let expected_trace_2 = vec![
        ...
        executed_state::fold(vec![
            ...
            executed_state::subtrace_lore(9, subtrace_desc(17 as PosType, 2), subtrace_desc(21 as PosType, 0)),
            executed_state::subtrace_lore(12, subtrace_desc(19 as PosType, 2), subtrace_desc(21 as PosType, 0)),
            executed_state::subtrace_lore(8, subtrace_desc(21 as PosType, 2), subtrace_desc(25 as PosType, 0)),
            executed_state::subtrace_lore(13, subtrace_desc(23 as PosType, 2), subtrace_desc(25 as PosType, 0)),
        ]),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
    ...
    let expected_trace_3 = vec![
        ...
        executed_state::fold(vec![
            ...
            executed_state::subtrace_lore(8, subtrace_desc(21 as PosType, 2), subtrace_desc(25 as PosType, 0)),
            executed_state::subtrace_lore(13, subtrace_desc(23 as PosType, 2), subtrace_desc(25 as PosType, 0)),
            executed_state::subtrace_lore(10, subtrace_desc(25 as PosType, 2), subtrace_desc(29 as PosType, 0)),
            executed_state::subtrace_lore(11, subtrace_desc(27 as PosType, 2), subtrace_desc(29 as PosType, 0)),
        ]),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
...
fn stream_merging_v1() {
    ...
    let expected_trace_1 = vec![
        ...
        executed_state::request_sent_by(initiator_id),
        executed_state::fold(vec![
            executed_state::subtrace_lore(7, subtrace_desc(15 as PosType, 2), subtrace_desc(23 as PosType, 1)),
            executed_state::subtrace_lore(9, subtrace_desc(17 as PosType, 2), subtrace_desc(22 as PosType, 1)),
            executed_state::subtrace_lore(12, subtrace_desc(19 as PosType, 2), subtrace_desc(21 as PosType, 1)),
        ]),
        executed_state::par(7, 1),
        executed_state::scalar_string(unit_call_service_result),
    ...
    let expected_trace_2 = vec![
        ...
        executed_state::fold(vec![
            ...
            executed_state::subtrace_lore(9, subtrace_desc(17 as PosType, 2), subtrace_desc(22 as PosType, 1)),
            executed_state::subtrace_lore(12, subtrace_desc(19 as PosType, 2), subtrace_desc(21 as PosType, 1)),
            executed_state::subtrace_lore(8, subtrace_desc(24 as PosType, 2), subtrace_desc(29 as PosType, 1)),
            executed_state::subtrace_lore(13, subtrace_desc(26 as PosType, 2), subtrace_desc(28 as PosType, 1)),
        ]),
        executed_state::par(7, 1),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::par(4, 1),
    ...
    let expected_trace_3 = vec![
        ...
        executed_state::fold(vec![
            ...
            executed_state::subtrace_lore(8, subtrace_desc(24 as PosType, 2), subtrace_desc(29 as PosType, 1)),
            executed_state::subtrace_lore(13, subtrace_desc(26 as PosType, 2), subtrace_desc(28 as PosType, 1)),
            executed_state::subtrace_lore(10, subtrace_desc(30 as PosType, 2), subtrace_desc(35 as PosType, 1)),
            executed_state::subtrace_lore(11, subtrace_desc(32 as PosType, 2), subtrace_desc(34 as PosType, 1)),
        ]),
        executed_state::par(7, 1),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::par(4, 1),
...
fn stream_merging_v2() {
    ...
    let expected_trace_1 = vec![
        ...
        executed_state::request_sent_by(initiator_id),
        executed_state::fold(vec![
            executed_state::subtrace_lore(7, subtrace_desc(15 as PosType, 1), subtrace_desc(21 as PosType, 2)),
            executed_state::subtrace_lore(9, subtrace_desc(16 as PosType, 1), subtrace_desc(19 as PosType, 2)),
            executed_state::subtrace_lore(12, subtrace_desc(17 as PosType, 1), subtrace_desc(18 as PosType, 2)),
        ]),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
    ...
    let expected_trace_2 = vec![
        ...
        executed_state::stream_string("2", 1),
        executed_state::fold(vec![
            executed_state::subtrace_lore(7, subtrace_desc(15 as PosType, 0), subtrace_desc(19 as PosType, 2)),
            executed_state::subtrace_lore(9, subtrace_desc(15 as PosType, 0), subtrace_desc(17 as PosType, 2)),
            executed_state::subtrace_lore(12, subtrace_desc(15 as PosType, 0), subtrace_desc(15 as PosType, 2)),
            executed_state::subtrace_lore(8, subtrace_desc(21 as PosType, 0), subtrace_desc(23 as PosType, 2)),
            executed_state::subtrace_lore(13, subtrace_desc(21 as PosType, 0), subtrace_desc(21 as PosType, 2)),
        ]),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
    ...
    let expected_trace_3 = vec![
        ...
        executed_state::fold(vec![
            ...
            executed_state::subtrace_lore(8, subtrace_desc(21 as PosType, 0), subtrace_desc(23 as PosType, 2)),
            executed_state::subtrace_lore(13, subtrace_desc(21 as PosType, 0), subtrace_desc(21 as PosType, 2)),
            executed_state::subtrace_lore(10, subtrace_desc(25 as PosType, 0), subtrace_desc(27 as PosType, 2)),
            executed_state::subtrace_lore(11, subtrace_desc(25 as PosType, 0), subtrace_desc(25 as PosType, 2)),
        ]),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
        executed_state::scalar_string(unit_call_service_result),
