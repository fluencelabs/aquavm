...
fn issue_211() {
    ...
    let expected_trace = ExecutionTrace::from(vec![
        ...
        executed_state::canon(json!({
            "tetraplet": {"function_name": "", "lambda": "", "peer_pk": peer_1_id, "service_id": ""},
            "values": [
                {
                    "result": 1,
                    "tetraplet": {"function_name": "nodes", "lambda": ".$.[0]", "peer_pk": peer_1_id, "service_id": "getdatasrv..1"},
                    "provenance": Provenance::service_result(cid_2.clone()),
                },
                {
                    "result": 2,
                    "tetraplet": {"function_name": "nodes", "lambda": ".$.[1]", "peer_pk": peer_1_id, "service_id": "getdatasrv..1"},
                    "provenance": Provenance::service_result(cid_2.clone()),
                },
                {
                    "result": 3,
                    "tetraplet": {"function_name": "nodes", "lambda": ".$.[2]", "peer_pk": peer_1_id, "service_id": "getdatasrv..1"},
                    "provenance": Provenance::service_result(cid_2.clone()),
                },
            ]
        })),
