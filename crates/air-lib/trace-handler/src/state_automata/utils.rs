...
impl CtxState {
    ...
    pub(super) fn update_ctx_state<VT>(self, ctx: &mut MergeCtx<VT>) -> FSMResult<(), VT> {
        ctx.slider
...
pub(super) fn update_ctx_states<VT>(state_pair: CtxStatesPair, data_keeper: &mut DataKeeper<VT>) {
