...
impl ParBuilder {
    ...
    pub(super) fn from_keeper<VT>(data_keeper: &DataKeeper<VT>, _: &StateInserter) -> Self {
    ...
    pub(super) fn track<VT>(&mut self, data_keeper: &DataKeeper<VT>, subtree_type: SubtreeType) {
